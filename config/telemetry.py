...
TELEMETRY_CHECK_CACHE_TTL_SECONDS = env_int(
    "TELEMETRY_CHECK_CACHE_TTL_SECONDS", 60
) or 60
TELEMETRY_API_KEY = os.getenv("TELEMETRY_API_KEY", "").strip()
TELEMETRY_SNAPSHOT_SECONDS = env_int("TELEMETRY_SNAPSHOT_SECONDS", 10) or 10
CONTROL_ENDPOINT = os.getenv("CONTROL_ENDPOINT", "").strip()
CONTROL_POLL_SECONDS = env_int("CONTROL_POLL_SECONDS", 10) or 10
...
TOKEN_EXPIRY = env_int("TOKEN_EXPIRY", 60 * 24 * 365)
if TOKEN_EXPIRY is None:
    TOKEN_EXPIRY = 60 * 24 * 365
