...
USE_GPU = True
ROTATE_INTERVAL_SECONDS = VANITY_ROTATE_SECONDS or 60
...
STATS_TO_DISPLAY = {
    ...
    "altcoin_files_converted": False,
    "altcoin_files_converted_today": True,
    "altcoin_files_converted_lifetime": True,
    "derived_addresses_today": True,
    "derived_addresses_lifetime": True,
...
METRICS_LABEL_MAP = {
    ...
    "altcoin_files_converted": "Converted CSVs (Legacy)",
    "altcoin_files_converted_today": "Converted CSVs Today",
    "altcoin_files_converted_lifetime": "Converted CSVs Lifetime",
    "derived_addresses_today": "Derived Addresses Today",
    "derived_addresses_lifetime": "Derived Addresses Lifetime",
    ...
    "btc_only_matches_found_today": "BTC Matches Lifetime",
